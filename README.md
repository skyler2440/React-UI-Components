...
- Inside of `../../social-card` you'll then need to run `yarn start` to open up a a Development Server that can take your `.js` files as components and bundle them up to work in your new environment.
